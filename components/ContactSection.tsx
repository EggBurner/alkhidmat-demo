...
const ContactSection = () => {
  return (
    <div className="relative mt-5 p-15">
      ...
      <div className="mx-auto mt-8 grid w-[80%] grid-cols-[3.5fr_6.5fr] overflow-hidden rounded-4xl border border-white shadow-[0_0_15px_rgba(0,0,0,0.15)]">
        <ContactSideBar />
        <ContactForum />
      </div>
