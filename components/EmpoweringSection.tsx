...
const EmpoweringSection = () => {
  return (
    <div className="mx-auto h-90 w-[90%] rounded-4xl bg-white bg-[url('/man_laptop_one.jpg')] bg-cover bg-center bg-no-repeat pt-8 pb-16">
      <div className="white-grad mx-auto mt-8 flex w-[50%] flex-col gap-8 rounded-4xl px-4 py-8 text-center leading-8">
        ...
        <p className="mx-auto w-[90%] text-sm tracking-wider text-white">
